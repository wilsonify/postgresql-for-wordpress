...
final class ParseTest extends TestCase
{
    public function test_it_can_parse_a_theme_change_correctly()
    {
        ...
        pg4wp_rewrite($sql);
        $this->assertSame("wp_options", $GLOBALS['pg4wp_ins_table']);
        $this->assertSame("option_name", $GLOBALS['pg4wp_ins_field']);
    }
    ...
    public function test_it_can_parse_a_page_creation_correctly()
    {
        ...
        pg4wp_rewrite($sql);
        $this->assertSame("wp_posts", $GLOBALS['pg4wp_ins_table']);
        $this->assertSame("post_author", $GLOBALS['pg4wp_ins_field']);
    }
